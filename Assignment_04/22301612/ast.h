...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        if (index) {
            ...
            string res_temp = "t" + to_string(temp_count++);
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        string res_temp = "t" + to_string(temp_count++);
        outcode << res_temp << " = " << left_temp << " " << op << " " << right_temp << endl;
        return res_temp;
    }
};
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        string res_temp = "t" + to_string(temp_count++);
        outcode << res_temp << " = " << op << expr_temp << endl;
        return res_temp;
    }
};
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        outcode << "if !" << cond_temp << " goto " << else_label << endl;
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
                        int& temp_count, int& label_count) const override {
        if (expr) {
            string res_temp = expr->generate_code(outcode, symbol_to_temp, temp_count, label_count);
            outcode << "return " << res_temp << endl;
        } else {
            outcode << "return" << endl;
        }
        return "";
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        for (auto var : vars) {
            ...
            if (var.second > 0) outcode << "[" << var.second << "]";
            outcode << endl;
        }
        return "";
    }
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
                        int& temp_count, int& label_count) const override {
        outcode << endl << name << ":" << endl;
        outcode << "begin_func" << endl;
        if (body) {
            body->generate_code(outcode, symbol_to_temp, temp_count, label_count);
        }
        outcode << "end_func" << endl;
        return "";
    }
};
...
public:
    ...
    string generate_code(ofstream& outcode, map<string, string>& symbol_to_temp,
        ...
        for (auto arg_temp : arg_temps) {
            outcode << "push " << arg_temp << endl;
        }
        outcode << "call " << func_name << ", " << arguments.size() << endl;
        string res_temp = "t" + to_string(temp_count++);
        outcode << res_temp << " = get_return" << endl;
        return res_temp;
    }
};
