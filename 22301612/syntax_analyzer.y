...
%token IF ELSE FOR WHILE DO BREAK INT CHAR FLOAT DOUBLE VOID RETURN SWITCH CASE DEFAULT CONTINUE GOTO PRINTLN ID CONST_INT CONST_FLOAT ADDOP MULOP RELOP LOGICOP NOT ASSIGNOP INCOP DECOP LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA COLON
...
compound_statement : LCURL statements RCURL
	{
		...
		outlog<<$1->getname()<<" "<<$2->getname()<<" "<<$3->getname()<<endl<<endl;
		$$ = new symbol_info($1->getname()+" "+$2->getname()+" "+$3->getname(),"compound_statement");
	}
	| LCURL RCURL
	{
		outlog<<"At line no: "<<lines<<" compound_statement : LCURL RCURL "<<endl<<endl;
		outlog<<$1->getname()<<" "<<$2->getname()<<endl<<endl;
		$$ = new symbol_info($1->getname()+" "+$2->getname(),"compound_statement");
	}
	;
...
var_declaration : type_specifier declaration_list SEMICOLON
	{
		...
		outlog<<$1->getname()<<" "<<$2->getname()<<" "<<$3->getname()<<endl<<endl;
		$$ = new symbol_info($1->getname()+" "+$2->getname()+" "+$3->getname(),"var_declaration");
	}
	;
...
statement : var_declaration
	...
	| RETURN expression SEMICOLON
	{
		...
		outlog<<$1->getname()<<" "<<$2->getname()<<" "<<$3->getname()<<endl<<endl;
		$$ = new symbol_info($1->getname()+" "+$2->getname()+" "+$3->getname(),"statement");
	}
	;
...
expression_statement : SEMICOLON
	...
	| expression SEMICOLON
	{
		...
		outlog<<$1->getname()<<" "<<$2->getname()<<endl<<endl;
		$$ = new symbol_info($1->getname()+" "+$2->getname(),"expression_statement");
	}
	;
